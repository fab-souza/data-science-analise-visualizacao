...
![Badge code size](https://img.shields.io/github/languages/code-size/fab-souza/data-science-analise-visualizacao)
...
Utilizamos três bases de dados neste curso, todas relacionadas a filmes. A primeira é sobre as notas que o usuário atribuiu aos filmes que já assistiu, a segunda contém o título dos filmes e seus gêneros, enquanto a última era um dataset mais robusto, pois há informações sobre o orçamento, idioma original, sinopse, popularidade, data de lançamento, nota média, quantidade de votos que o filme recebeu, etc.
...
Até o momento, eu estava replicando o que aprendi nos cursos da Alura. Porém, decidi apresentar esta prática de outra forma, por dois motivos:
...
Finalizando com a origem dos grãos, criei o novo dataframe com as 25 melhores médias. O fabricante com mais produtos é a canadense *Soma*, com 9 produtos. A barra de chocolate com mais aparições foi o *Honduras*, fabricado por três empresas de países distintos. 
